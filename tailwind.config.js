  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "button-primary-fill":
          "linear-gradient(to bottom, rgba(232, 226, 255, 0.4) 0%, rgb(202, 187, 255) 90.385%), linear-gradient(#FFFFFF, #FFFFFF)",
        "button-border-dark":
          "linear-gradient(to bottom, rgba(232, 226, 255, 0.4) 0%, #CABBFF 100%)",
        "button-border-light":
          "linear-gradient(to bottom, #AD9BDD 0%, #7B68A6 100%)",
      },
      boxShadow: {
