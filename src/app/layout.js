...
import { untitledSans, youth, druk, leagueSpartan } from "./fonts";
...
export default function RootLayout({ children }) {
	return (
		<html lang='en' className={`${untitledSans.variable} ${youth.variable} ${druk.variable} ${leagueSpartan.variable}`}>
			<head>
				<PlausibleProvider
					domain='celestia.org'
