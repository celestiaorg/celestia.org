...
export default function IntermediatesLayout({ children }) {
	const routeTabNavigation = {
		...
		"Modular software vs modular blockchains": "/learn/intermediates/the-differences-of-modular-software",
		"An introduction to sovereign rollups": "/learn/intermediates/sovereign-rollups-an-introduction",
		"Misconceptions of sovereign rollups": "/learn/intermediates/sovereign-rollups-misconceptions",
		"Settlement in the modular stack": "/learn/intermediates/settlement-in-the-modular-stack",
	};
