    ...
    <>
      ...
      <TertiaryPageContainer>
        ...
        <TertiaryPageContainer.Body>
          <Section>
            <Body>
              These Terms govern your access to and use of any of the Services.
              Please read these Terms carefully, as they include important
              information about your legal rights. These Terms contain a
              disclaimer of warranties, limitations of liability, a time-bar for
              claims, and indemnification obligations, among other provisions,
              which could affect your legal rights. By using the Services you
              agree to be bound by these terms and any other terms and policies
              incorporated to these Terms by reference. If you do not understand
            ...
            <Body>
              The Celestia protocol is a decentralized modular blockchain
              protocol created to enable others to easily deploy their own
              blockchain with minimal overhead (the “Celestia Protocol”). The
              Celestia Protocol is not part of the Website, and is not a Service
              and does not constitute any element of the Services. We do not
              control the Celestia Protocol or any deployment of the Celestia
              Protocol in any testnet or mainnet environment, and accept no
              liability for the operation of any of the foregoing. The Celestia
              Protocol continues to evolve through its communities of users. We
              are a member of those communities and we contribute to the
              continuing development of the Celestia Protocol, including by
              making available documentation and other tools. Your use of the
              Celestia Protocol and any testnet or mainnet deployment of the
              Celestia Protocol is entirely at your own risk.
            </Body>
            <Body className={"uppercase"}>
              ...
              class action waiver as explained in section 9.
            </Body>
          </Section>
          <Section id={"who-may-use-the-services"}>
            ...
            <Body>
              ...
              or older, not be a Prohibited Person, and not have been previously
          ...
          <Section id={"the-services"}>
            ...
            <Body>
              We may make any improvement, modifications or updates to the
              Services, including but not limited to changes and updates to the
              underlying software, infrastructure, security protocols, technical
              configurations or service features (the “Updates”) from time to
              time. Your continued access and use of the Services are subject to
              such Updates and you shall accept any patches, system upgrades,
              bug fixes, feature modifications, or other maintenance work that
              arise out of such Updates. We are not liable for any failure by
              you to accept and use such Updates in the manner specified or
              required by us. Although the Company is not obligated to monitor
              access to or participation in the Services, it has the right to do
              so for the purpose of operating the Services, to ensure compliance
              with the Terms and to comply with applicable law or other legal
              requirements.
            </Body>
            <Heading tag={"h3"} size={"sm"}>
              2.2 Wallets
            ...
            <Body>
              The Services may require you to connect your own third-party
              self-custodial digital wallets (“Wallets”), including in
              connection with your use of Testnets (as defined below). A
              self-custodial Wallet means we do not own or control your Wallet.
              You are solely responsible for keeping your Wallet and any private
              keys necessary to decrypt your Wallet secure and you should never
              share your Wallet seed phrase or private keys with anyone else via
              the Services. We have no ability to help you access or recover
              your private keys for your Wallet. By using such Wallets to
              conduct transactions via the Services, you agree that you are
              governed by the terms of service and privacy policy for the
              applicable Wallets, and that the Company has no responsibility or
              liability to you in any way arising from your use of such
              third-party Wallets, including for any security failures or other
              errors or failures of such Wallets. We reserve the right to
              restrict any Wallet addresses from interacting with the Services
              for any reason, including to ensure legal compliance.
            </Body>
          </Section>
          <Section id={"testnets"}>
            <Heading tag={"h2"} className={"uppercase mb-6"}>
            ...
            <Body>
              The Website may enable you to interact with deployments of the
              Celestia Protocol in testnet environments (“Testnets”), including
              but not limited to the Mamaki Testnet, the Arabica Testnet, and
              the Mocha Testnet. Testnets are designed to enable the community
              of Celestia Protocol users to understand the protocol’s
              functionality and explore potential improvements to the
              operational experience, security, and design of the Celestia
              Protocol. The Testnets are operated and maintained by the
              community of Celestia Protocol users and the Testnets are not part
              of the Services.{" "}
              <span className="uppercase">
                Your participation in any testnet is entirely voluntary
              </span>
              .
            </Body>
            <Heading tag={"h3"} size={"sm"}>
            ...
            <Body>
              The availability of a Testnet is solely subject to the decision
              and activities of the community of Celestia Protocol users. The
              Company has no ability to and bears no responsibility to commence,
              terminate, or modify a Testnet.
            </Body>
            <Heading tag={"h3"} size={"sm"}>
              3.3 No Monetary Value
            </Heading>
            <Body>
              In your use of a Testnet, you may accumulate “Testnet Tokens,”
              such as through a faucet, which are not, and shall never convert
              to or accrue to become any other tokens or virtual assets outside
              of the respective Testnet on which the Testnet Tokens were issued.
              Testnet Tokens are virtual items with no monetary value. Testnet
              Tokens do not constitute any currency or property of any type and
              are not redeemable, refundable, or eligible for any fiat or
              virtual currency or anything else of value. Testnet Tokens are not
              transferable between users outside of the respective Testnet on
              which the Testnet Tokens were issued, and you may not attempt to
              sell, trade, or transfer any Testnet Tokens outside of that
              respective Testnet, or obtain any manner of credit using any
              Testnet Tokens. Any attempt to sell, trade, or transfer any
              Testnet Tokens outside of the respective Testnet will be null and
              void. Testnet Tokens will not be converted into any future rewards
          ...
          <Section id={"location-of-our-privacy-policy"}>
            ...
            <Body>
              ...
              https://celestia.org/privacy. If a specific Service is governed by
              a separate set of terms, those terms may also contain
          ...
          <Section id={"rights-we-grant-you"}>
            ...
            <Body>
              ...
              non-commercial use only, provided that you comply with these Terms
              in connection with all such use. If any software, content or other
              materials owned or controlled by us are distributed to you as part
              of your use of the Services, we hereby grant you, a personal,
              ...
              Services, in each case for the sole purpose of enabling you to use
              the Services as permitted by these Terms. Your access and use of
              the Services may be interrupted from time to time for any of
              ...
              or other actions that the Company, in its sole discretion, may
              elect to take.
            </Body>
            <Heading tag={"h3"} size={"sm"}>
            ...
            <Body>
              You may not do any of the following in connection with your use of
              the Services, unless applicable laws or regulations prohibit these
              restrictions or you have our written permission to do so (such as
              pursuant to one or more open source licenses that we may apply to
            ...
            <ListItem lightMode type="number" index={"a"}>
              ...
              automatically cached by your web browser for display purposes, or
              as otherwise expressly permitted in these Terms;
            </ListItem>
            ...
            <ListItem lightMode type="number" index={"d"}>
              ...
              Services or impersonate a real-person or to exaggerate or
              misrepresent your engagement with the Services;
            </ListItem>
            ...
            <ListItem lightMode type="number" index={"g"}>
              ...
              disrupt the Services, or the computer systems or networks
            ...
            <ListItem lightMode type="number" index={"i"}>
              use any device, process, or software to manipulate or disrupt
              anyone else’s use of the Services, including but not limited to
              posting or distributing commercial spam; attempting to
              artificially inflate your engagement with the Services; engaging
              in coordinated harmful activity to encourage or promote violations
              of these Terms; or mass-registering for accounts related to or
          ...
          <Section id={"ownership-and-content"}>
            ...
            <Body>
              ...
              in connection with the Services and its content including, without
            ...
            <Body>
              The Company’s name, the Company’s logo and all related names,
            ...
            <Body>
              ...
              the Services (“Feedback”). You acknowledge and expressly agree
              that any contribution of Feedback does not and will not give or
              grant you any right, title or interest in the Services or in any
              such Feedback. All Feedback becomes the sole and exclusive
              property of the Company, and the Company may use and disclose
              ...
              the Company any and all right, title and interest (including, but
          ...
          <Section id={"third-party-services-and-materials"}>
            ...
            <Body>
              The Services may include Third-Party software components that are
              subject to open source and/or pass-through commercial licenses
              and/or notices (“Third-Party Software” and “Third-Party Software
              Terms and Notices”, respectively). You acknowledge that your use
              of the Services may be also governed by such Third-Party Software
              Terms and Notices, and that to the extent of any conflict between
              these Terms and any Third-Party Software Terms and Notices, the
              latter shall control. Any undertakings, representations,
              warranties, guarantees, conditions, indemnities or other
              commitments made by the Company in these Terms concerning the
              Services (if any), are made by the Company and not by any authors,
              licensors, or suppliers of, or contributors to, such Third-Party
              Software. Notwithstanding the foregoing sentence or anything in
              these Terms to the contrary, the Company does not make any
              representation, warranty, guarantee, or condition, and does not
              undertake any defense or indemnification, with respect to any
          ...
          <Section id={"disclaimers-liability-indemnification"}>
            ...
            <ListItem lightMode type="number" index={"a"}>
              ...
              “Company Entities”){" "}
              <span className="uppercase">
                Disclaim all representations, warranties and conditions, whether
                express, implied, or statutory, including without limitation any
                representations or warranties relating to title,
                non-infringement, merchantability, usage, quality, performance,
                suitability or fitness of the services for any particular
                purpose, or as to the accuracy, quality, sequence, reliability,
                workmanship or technical coding thereof, or the absence of any
                defects therein whether latent or patent
              </span>
              . The Company Entities make no warranty or representation and
              disclaim all responsibility and liability for: (a) the
              completeness, accuracy, availability, timeliness, security or
              reliability of the Services; (b) any harm to your computer system,
              corrupted Wallet files, loss of data, or other harm that results
              ...
              or device; and (d) whether the Services will meet your
            ...
            <ListItem lightMode type="number" index={"b"}>
              <span className="uppercase">
                The laws of certain jurisdictions, including new jersey, do not
            ...
            <ListItem lightMode type="number" index={"c"}>
              <span className="uppercase">
                You acknowledge and agree that this section 8.1 is an essential
            ...
            <Body>
              <span className={"uppercase"}>
                ...
                you for any damages finally awarded shall not exceed one hundred
                dollars ($100.00). The foregoing limitations will apply even if
                the above stated remedy fails of its essential purpose.
              </span>{" "}
              Some jurisdictions laws do not allow the exclusion or limitation
              of incidental or consequential damages, or of other damages, and
              to the extent applicable to you, such exclusions and limitations
              may not apply but will apply to the maximum extent permitted by
              applicable law.{" "}
              <span className="uppercase">
                You acknowledge and agree that this section 8.2 is an essential
                basis of the bargain between you and the company.
              </span>
            </Body>
            <Heading tag={"h3"} size={"sm"}>
            ...
            <ListItem lightMode type="number" index={"a"}>
              ...
              including a sufficient understanding of blockchain or
              cryptographic tokens and technologies and other digital assets,
              storage mechanisms (such as Wallets), blockchain-based software
              ...
              amounts paid, and the risk that any tokens you receive as a result
              of your use of the Services may have little or no value. You
              acknowledge and agree that there are risks associated with
              interacting with cryptographic tokens and using blockchain
              technology. These include, but are not limited to, risk of losing
              access to cryptocurrency due to loss of private key(s), custodial
              error or purchaser error, risk of mining or blockchain attacks,
              risk of hacking and security weaknesses, risk of unfavorable
              regulatory intervention in one or more jurisdictions, risk related
              to token taxation, risk of personal information disclosure, risk
              of uninsured losses, volatility risks, and unanticipated risks.
            </ListItem>
            <ListItem lightMode type="number" index={"b"}>
              The regulatory regime governing blockchain technologies and
              cryptographic tokens is uncertain, and new regulations or policies
              may materially adversely affect the potential utility or value of
              any tokens you receive as a result of your use of the Services.
              There also exists the risks of new taxation of the purchase or
              sale of tokens.
            </ListItem>
            <ListItem lightMode type="number" index={"c"}>
              There are risks associated with using blockchains and
              cryptographic tokens, including, but not limited to, the risk of
              failures of hardware, software, and Internet connections, the risk
              of malicious software introduction, and the risk that third
              parties may obtain unauthorized access to information stored
              within your Wallet or elsewhere. The Company is not responsible
              for any such risks, however caused.
            </ListItem>
            <ListItem lightMode type="number" index={"d"}>
              We do not control the Celestia Protocol, any blockchains or other
              networks that deploy the Celestia Protocol, or any software that
              interacts with the Celestia Protocol. The Company is not
              responsible for changes, upgrades, or forks of the Celestia
              Protocol or any damage resulting from the foregoing, however
              caused.
            </ListItem>
            <Heading tag={"h3"} size={"sm"}>
              8.4 Indemnification
            ...
            <Body>
              ...
              you agree that you shall defend, indemnify and hold the Company
              Entities harmless from and against any and all claims, costs,
              damages, losses, liabilities and expenses (including attorneys’
              fees and costs) incurred by the Company Entities arising out of or
              in connection with: (a) your violation or breach of any term of
              these Terms or any applicable law or regulation, including any
              such violation or breach related to any rewards that may be
              available as a result of your participation in a program
              maintained by us or our affiliates; (b) your violation of any
              rights of any Third-Party; (c) your misuse of the Services; (d)
              your negligence or wilful misconduct. If you are obligated to
              indemnify any Company Entity hereunder, then you agree that
              Company (or, at its discretion, the applicable Company Entity)
              will have the right, in its sole discretion, to control any action
              or proceeding and to determine whether Company wishes to settle,
          ...
          <Section id={"arbitration-and-class-action-waiver"}>
            ...
            <Heading tag={"h3"} size={"sm"}>
              <span className="uppercase">
                9.1 Please read this section carefully – it may significantly
                affect your legal rights, including your right to file a lawsuit
                in court and to have a jury hear your claims. It contains
            ...
            <Body>
              You and the Company agree that in the event of any dispute between
              you and the Company Entities, either party will first contact the
              other party and make a good faith sustained effort to resolve the
              dispute before resorting to more formal means of resolution,
              including without limitation, any court action, after first
              allowing the receiving party 30 days in which to respond. Both you
              and the Company agree that this dispute resolution procedure is a
            ...
            <Body>
              ...
              dispute, controversy, or claim (collectively, “Claim”) relating in
              any way to the Company’s services and/or products, including the
              Services, and any use or access or lack of access thereto, will be
              resolved by arbitration, including threshold questions of
              arbitrability of the Claim. You and the Company agree that any
              Claim will be settled by final and binding arbitration, using the
              English language, administered in accordance with the
              Liechtenstein Arbitration Rules (LIS) of the Liechtenstein Chamber
              of Commerce and Industry. The seat of the arbitral tribunal will
              be Vaduz, Liechtenstein and the arbitral proceeding will be
              conducted in English. The arbitrator will apply applicable
              substantive law consistent with the laws of the Principality of
              Liechtenstein. Judgment on the arbitration award may be entered in
              ...
              class actions are not permitted. You understand that by agreeing
              to these Terms, you and the Company are each waiving the right to
            ...
            <Body>
              ...
              expenses will be governed by LIS rules, except that if you
            ...
            <Body>
              ...
              for an improper purpose, then the payment of all fees will be
              governed by the LIS rules. In that case, you agree to reimburse
              the Company for all monies previously disbursed by it that are
              otherwise your obligation to pay under the applicable rules. If
              you prevail in the arbitration and are awarded an amount that is
              less than the last written settlement amount offered by the
              Company before the arbitrator was appointed, the Company will pay
              you the amount it offered in settlement. The arbitrator may make
            ...
            <Heading tag={"h3"} size={"sm"}>
              <span className="uppercase">
                9.6 Waiver of right to bring class action and representative
                claims
              </span>
            </Heading>
            <Body>
              <span className="uppercase">
                ...
                respective party’s individual capacity and not as part of any
                class (or purported class), consolidated, multiple-plaintiff, or
                representative action or proceeding (“class action”). You and
                the company agree to waive the right to participate as a
                plaintiff or class member in any class action. You and the
                company expressly waive any ability to maintain a class action
                in any forum. If the dispute is subject to arbitration, the
            ...
            <Body>
              <span className="uppercase">
                ...
                otherwise, the parties’ agreement to arbitrate shall be null and
                void with respect to such proceeding so long as the proceeding
                is permitted to proceed as a class action. If a court decides
                that the limitations of this paragraph are deemed invalid or
                unenforceable, any putative class, private attorney general, or
                consolidated or representative action must be brought in a court
            ...
            <Body>
              <span className="uppercase">
                To the fullest extent permitted by applicable law, any claim or
                cause of action arising out of, or related to, these terms must
                be filed within 1 year after such claim or cause of action
                arose, or else you agree that such claim or cause of action will
          ...
          <Section id={"additional-provisions"}>
            ...
            <Body>
              ...
              attempt to notify you, such as by placing a prominent notice on
            ...
            <Body>
              You agree that the Company may send you notices by email, physical
              mail, or by posting on or through the Website.
            </Body>
            <Heading tag={"h3"} size={"sm"}>
            ...
            <Body>
              ...
              granted to you by the Company will terminate automatically. All
              ...
              and notwithstanding any termination of these Terms by the Company
            ...
            <Body>
              ...
              Persons List or Entity List. By using the Services, you represent
            ...
            <Body>
              ...
              defaulted under or breached these Terms, for any failure or delay
              in fulfilling or performing any of our obligations under these
              Terms or in providing the Services, when and to the extent such
              failure or delay is caused by or results from any events beyond
              our ability to control, including acts of God, flood, fire,
              earthquake, epidemics, pandemics, tsunami, explosion, war,
              invasion, hostilities (whether war is declared or not), terrorist
              threats or acts, riot or other civil unrest, government order,
              law, or action, embargoes or blockades, strikes, labor stoppages
              or slowdowns or other industrial disturbances, shortage of
              adequate or suitable Internet connectivity, telecommunication
              breakdown or shortage of adequate power or electricity, and other
            ...
            <Body>
              ...
              not be assigned by you without the prior express written consent
              of the Company. No waiver by either party of any breach or default
              ...
              The Services are operated by us in Liechtenstein. Those who choose
              to access the Services from locations outside Liechtenstein do so
              at their own initiative and are responsible for compliance with
              applicable local laws. These Terms are governed by the laws of the
              Principality of Liechtenstein District Court and any appellate
              court from any such court, and the proper venue for any disputes
              arising out of or relating to any of the same will be the
              arbitration venue set forth in Section 9, or if arbitration does
              not apply, then the aforementioned Liechtenstein courts.
            </Body>
            <Heading tag={"h3"} size={"sm"}>
            ...
            <Body>
              ...
              Pradafant 11, 9490 Vaduz, Principality of Liechtenstein, or by
              e-mail at legal@celestia.org.
            </Body>
          </Section>
        </TertiaryPageContainer.Body>
      </TertiaryPageContainer>
