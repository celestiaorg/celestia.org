					...
					{items.map((item, i) => (
						<Fragment key={item.title}>
							...
							<motion.div
								...
								variants={itemVariants}
							>
								<h3 className='font-nuberNextWide text-[20px] font-medium leading-[1.25] tracking-[-0.025em] text-[#FDFCFF] min-[431px]:text-[21px] min-[768px]:text-[24px] min-[900px]:min-h-[2.5em]'>
									{item.title}
								</h3>
								<p className='font-nuberNext text-[16px] leading-[1.5] tracking-[-0.01em] text-[#C4C8CE]'>
									{item.body}
								</p>
							</motion.div>
						</Fragment>
