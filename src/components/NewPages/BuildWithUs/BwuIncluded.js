	...
	return (
		<section id='included' data-header-theme='dark' className='bg-[#040207]'>
			<div className='mx-auto flex max-w-[1520px] flex-col gap-10 px-6 py-12 min-[680px]:px-[60px] min-[680px]:py-[60px] min-[1200px]:px-[120px] min-[1200px]:py-20'>
				<motion.h2
					className='font-nuberNext text-[17px] font-medium leading-[1.25] tracking-[-0.025em] text-white/45 min-[431px]:text-[18px] md:text-[24px]'
				...
				>
					{cards.map((card) => (
						...
						>
							...
							<h3 className='font-nuberNextWide text-[20px] font-medium leading-[1.25] tracking-[-0.025em] text-[#FDFCFF] transition-colors duration-[350ms] group-hover:text-[#0E1014] min-[431px]:text-[21px] min-[768px]:text-[24px]'>
								{card.title}
							</h3>
							<p className='font-nuberNext text-[16px] leading-[1.5] tracking-[-0.01em] text-[#C4C8CE] transition-colors duration-[350ms] group-hover:text-black/55'>
								{card.body}
							</p>
						</motion.div>
					))}
