	...
	return (
		...
		>
			<div className='flex flex-col gap-[10px]'>
				<h3 className='font-untitledSans font-medium text-[24px] leading-[32px] tracking-[-1px] text-white'>{title}</h3>
				<p className='font-untitledSans text-[14px] leading-[20px] text-[#d8cce5]'>{description}</p>
			</div>
			<div className='mt-6'>
...
const BuildDevResources = () => {
	return (
		<section id='dev-resources' data-header-theme='dark' className='bg-[#17141A] sm:pt-14 pb-[104px]'>
			<Container size='lg'>
				{/* Section heading */}
				<motion.h2
