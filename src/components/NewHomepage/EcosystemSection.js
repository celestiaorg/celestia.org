...
const EcosystemSection = () => {
	return (
		<section
			...
			className="relative z-[2] bg-[#FDFCFF] max-w-[1680px] mx-auto flex flex-col gap-12 py-12 px-6 min-[600px]:py-[60px] min-[600px]:px-[60px] min-[1200px]:py-20 min-[1200px]:px-[120px]"
		>
