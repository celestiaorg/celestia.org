...
const highlights = [
	{
		...
		description: (
			<>
				Celestia&apos;s blockspace powers Relay&apos;s cross-chain payments settlement — with{" "}
				<strong className='font-bold tracking-[-0.02em]'>&lt;1s fill times</strong>.
			</>
		),
		href: "#",
	},
	{
		...
		description: (
			<>
				...
				<strong className='font-bold tracking-[-0.02em]'>20k orders/second</strong> on Celestia&apos;s blockspace.
			</>
		),
		href: "#",
	},
...
const investors = [
	{ src: "/images/app/homepage/raise-logo-1.webp", alt: "Binance Labs", width: 147, height: 32 },
	{ src: "/images/app/homepage/raise-logo-2.webp", alt: "Maven 11", width: 159, height: 32 },
	{ src: "/images/app/homepage/raise-logo-3.webp", alt: "Bain Capital Crypto", width: 232, height: 32 },
	{ src: "/images/app/homepage/raise-logo-4.webp", alt: "Coinbase Ventures", width: 190, height: 32 },
	{ src: "/images/app/homepage/raise-logo-5.webp", alt: "Placeholder", width: 170, height: 32 },
];
			...
			{text.split("").map((char, i) => (
				<span
					...
					style={{
						...
						transform: isVisible ? "translateY(0) rotateX(0deg)" : "translateY(40px) rotateX(90deg)",
...
// Case study card
const HighlightCard = ({ logo, logoAlt, background, tag, description, href }) => {
	return (
		<motion.div variants={cardVariants}>
			...
			>
				...
				<div className='relative z-[3] flex flex-col justify-between p-5 md:p-6 w-full'>
					{/* Logo top */}
					<div>
						<img src={logo} alt={logoAlt} className='h-8 w-auto object-contain brightness-0 invert block' />
					</div>
