		...
		>
			<div className='mx-auto grid w-full max-w-[1280px] grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 lg:gap-20 items-start'>
				<motion.div
					...
					custom={0}
				>
					<h2 className='font-nuberNextWide font-medium text-[25px] min-[431px]:text-[28px] leading-[1.2] tracking-[-0.025em] md:text-[40px] md:leading-[1.1] md:tracking-[-0.025em] text-white/90 mb-8'>
						Private Markets,
						<br />
						Public Proof
					</h2>
				...
				<motion.div
					...
					custom={0.12}
				>
					<p className='font-nuberNext text-[16px] leading-[1.5] tracking-[-0.01em] text-white/[0.72] mb-7 m-0'>
					...
					<div className='border-l border-white/[0.12] pl-6'>
						<p className='font-nuberNext text-[16px] leading-[1.5] tracking-[-0.01em] text-white/[0.72] m-0'>
