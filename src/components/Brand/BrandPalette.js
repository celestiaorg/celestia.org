			...
			<div className="mx-auto w-full max-w-[1520px] px-6 min-[600px]:px-[60px] min-[1200px]:px-[120px]">
				...
				>
					...
					<motion.p className="font-nuberNext text-[16px] leading-[1.5] tracking-[-0.01em] text-[#4A5058]">
						Frost and Void anchor every surface; Indigo and Amethyst carry the brand. Four extended families — Neutral, Blue, Purple, and Beige — handle the rest. Click any colour to copy its hex.
					</motion.p>
				</motion.div>
