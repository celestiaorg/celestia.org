...
const ScrollSection = ({ index, children, id, canCopyLink = false, ...props }) => {
	...
	}, [pathname, id, canCopyLink]);

	return (
		<section id={id} className={`bg-white ${index > 0 ? "border-t border-black" : null}`} {...props}>
