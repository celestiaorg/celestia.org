...
interface ArrowLongSVGProps {
	dark?: boolean;
	className?: string;
}

const ArrowLongSVG = ({ dark = false, className = "" }: ArrowLongSVGProps) => {
	...
	return (
		<svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
				...
				fill={fill}
				className={`group-hover:fill-[${dark ? colors.black.DEFAULT : colors.white.DEFAULT}] transition duration-300 ${className}`}
			/>
		</svg>
	);
};
