...
type PrimaryButtonVariant = "purple" | "purple-bright" | "ghost" | "ghost-dark" | "outline";
type PrimaryButtonSize = "sm" | "md" | "lg" | "xl";
...
interface PrimaryButtonProps {
	...
	isActive?: boolean;
	variant?: PrimaryButtonVariant | null; // "purple" | "purple-bright" | "ghost" | "ghost-dark" | "outline" for new design
	showArrow?: boolean; // Show right arrow (for ghost variant)
}
