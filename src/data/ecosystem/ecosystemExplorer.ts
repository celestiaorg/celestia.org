export const ecosystemData = {
  ...
  items: [
    ...
    },
    {
      title: "Ham",
      description:
        "Empowering social connections with fun experiences built on decentralized systems.",
      image: "/images/app/ecosystem/ham.jpg",
      url: "https://ham.fun/home",
      chainIcon: "",
      chainIconLink: "",
      categories: "apps",
      subcategory: ["consumer"],
    },
    {
      title: "Form",
      description:
        "Form is a light speed, low-cost Ethereum L2 built to bring 50 million users to SocialFi by 2030.",
    ...
    },
    {
      title: "Rise",
      description:
        "Streamline payments to contractors and full-time employees around the globe.",
    ...
    },
    {
      ...
      description:
        "The First AI Marketplace on Blockchains. Buy. Sell. Borrow. Power of AI at your disposal.",
    ...
    },
    {
      title: "Echelon",
      description:
        "Move Lending | Borrow & Lend Against Yield-Bearing Assets, BTC & RWAs.",
    ...
    },
    {
      title: "MilkyWay",
      description:
        "The ultimate moo-dular staking portal for Liquid Staking and Restaking.",
    ...
    },
    {
      title: "Ethereal",
      description:
        "Next generation decentralized spot and perpetuals trading powered by USDe.",
    ...
    },
    {
      title: "Camp Network",
      description:
        "Built for the Future of AI and IP. Own and monetize your IP in an AI-driven world.",
    ...
    },
    {
      title: "Perennial",
      description:
        "Perennial is a dedicated perps rollup, engineered for hyper-efficient trading.",
    ...
    },
    {
      ...
      description:
        "Enable everyone to create interactive entertainment 10x faster and easier with AI x Web3.",
    ...
    },
    {
      title: "Happy Chain",
      description:
        "HappyChain is a blockchain focused on onchain games and social app.",
    ...
    },
    {
      title: "Winr",
      description:
        "WINR is the world's first decentralized gambling infrastructure, powering fully onchain casinos, games, and betting.",
    ...
    },
    {
      ...
      description:
        "Prime Protocol enables cross-chain deposits and borrows across any chain.",
    ...
    },
    {
      title: "Ancient 8",
      description:
        "The Ethereum L2 designed for on-chain gaming and tradable consumer Dapps, built on the Optimism Superchain.",
    ...
    },
    {
      ...
      description:
        "(Text)Adventures in composability... because words are the most composable primitive we have.",
    ...
    //RWA
    {
      title: "Converge",
      description:
        "The settlement layer for traditional finance and digital dollars.",
    ...
    // NFT
    {
      title: "Intergaze",
      description:
        "The home for minting and trading NFTs in the Interwoven Economy.",
    ...
    // Prediction market
    {
      title: "XO Market",
      description:
        "Open conviction markets for all. Create, trade and share your beliefs with.",
    ...
    // Payment
    {
      title: "Payy",
      description:
        "Payy gives you control of your money using stablecoins and a private, scalable payments blockchain.",
    ...
    // RaaS
    {
      title: "Alchemy",
      description:
        "The complete web3 development platform for wallets, rollups, and apps",
    ...
    },
    {
      title: "QuickNode",
      description:
        "Read, write, and build onchain with the fastest, most reliable infrastructure.",
    ...
    },
    {
      title: "Highlight",
      description:
        "A place for collecting, creating, and trading digital artifacts.",
    ...
    // Other
    {
      title: "K2",
      description:
        "K2 is a modular, restaked layer 2 blockchain with native risk management and AI infrastructure.",
    ...
    },
    {
      title: "RARI Chain",
      description:
        "The first creator-centric chain for the next generation of NFT use cases.",
    ...
    },
    {
      title: "Huddle01",
      description:
        "The ultra-low latency network. Powering real-time AI, communications and more.",
    ...
    },
    {
      title: "Gelato",
      description:
        "The #1 Rollup-As-A-Service Platform. 1-click ABC, OP, Orbit rollups.",
    ...
    },
    {
      title: "Gateway",
      description:
        "Complete blockchain infrastructure for your project, with tech advisory and native product ecosystem.",
    ...
    // Rollup stacks
    {
      ...
      description:
        "The ideal way to permissionlessly launch your own custom chain.",
    ...
    },
    {
      title: "OP Succinct",
      description:
        "Transform any OP Stack rollup into a fully type-1 ZK rollup using SP1.",
    ...
    },
    {
      title: "Evolve",
      description:
        "Own It. Shape It. Launch It. Build your network how you want to.",
    ...
    },
    {
      title: "Sovereign SDK",
      description:
        "Build real-time blockchains with the industry’s most flexible and performant toolkit — Sovereign SDK.",
    ...
    },
    {
      title: "Dojo",
      description:
        "Dojo is a provable game engine and toolchain for building high-performance onchain games and applications.",
    ...
    },
    {
      title: "Madara",
      description:
        "Building the integrity web with the most modular framework to create Validity Rollups.",
