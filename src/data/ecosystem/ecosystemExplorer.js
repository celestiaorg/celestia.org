export const ecosystemData = {
	...
	items: [
		...
		},
		{
			...
			chainIcon: "/images/app/ecosystem/eclipse.png",
		...
		{
			title: "Clique",
			description: "Secure Systems Solutions with TEE and MPC. Confidential & Verifiable Compute + Efficient Incentive Distribution.",
			image: "/images/app/ecosystem/clique.jpg",
		...
		{
			title: "LazyChain",
			description: "The interchaintest directory contains an e2e test suite for the LazyChain IBC setup.",
			image: "/images/app/ecosystem/lazy-chain.jpg",
			url: "https://github.com/Lazychain/lazychain",
			chainIcon: "",
			chainIconLink: "",
			categories: "apps",
			subcategory: ["nft"],
		...
		{
			title: "Wanderers",
			description: "Wanderers is an action deck-building roguelite, and you must save a galaxy on the brink of extinction.",
			image: "/images/app/ecosystem/wanderers.jpg",
