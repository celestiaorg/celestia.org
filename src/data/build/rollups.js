...
export const rollups = [
	{
		...
		description: "We offer a versatile rollup stack including Arbitrum Orbit, OP stack, Polygon zkEVM and StarkWare.",
	...
	},
	{
		title: "Astria",
		categories: [],
		description: "Astria lets rollups share a single decentralized network of sequencers that's simple and permissionless to join.",
		image: "/images/app/build/astria.png",
		url: "https://www.astria.org/",
		trackEvent: ANALYTICS_EVENTS.PORTAL_RAAS_ASTRIA,
	},
	{
		title: "Caldera",
		categories: ["Arbitrum ORBIT", "OP Stack"],
		description: "Caldera makes it easy to launch performant, customizable Arbitrum Orbit and OP Stack rollups. No code required.",
	...
	{
		title: "Karnot",
		categories: ["Starknet Stack"],
		description: "Karnot abstracts all the difficult parts of managing your own app chain so that you can build what really matters.",
		image: "/images/app/build/karnot.png",
		url: "https://www.karnot.xyz/",
		trackEvent: ANALYTICS_EVENTS.PORTAL_RAAS_KARNOT,
	},
	{
		title: "Lumoz",
		categories: ["Polygon CDK"],
		...
		url: "https://lumoz.org/",
		trackEvent: ANALYTICS_EVENTS.PORTAL_RAAS_LUMOZ,
	},
	{
		title: "Snapchain",
		categories: ["Polygon CDK"],
		description: "Leverage the power of ZK Rollups to scale your on-chain game or DeFi app cheaply and securely, without compromise.",
	...
	},
	{
		title: "Vistara",
		categories: [],
		description: "Vistara is building a Hardware availability layer for the modular web aiming to democratize access to decentralized hardware.",
		image: "/images/app/build/vistara.png",
		url: "https://docs.vistara.dev/",
		trackEvent: ANALYTICS_EVENTS.PORTAL_RAAS_VISTARA,
	},
	{
		title: "Zeeve",
		categories: ["Arbitrum ORBIT", "OP Stack", "Polygon CDK"],
		description: "Build, Customize, and Launch your production-grade Rollups with Zeeve’s Rollups as a Service (RaaS).",
